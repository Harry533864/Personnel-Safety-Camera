...
export BAUMER_BRIGHTNESS_AUTO_NOMINAL="${BAUMER_BRIGHTNESS_AUTO_NOMINAL:-28}"
export BAUMER_BRIGHTNESS_AUTO_PRIORITY="${BAUMER_BRIGHTNESS_AUTO_PRIORITY:-ExposureAuto}"
export BAUMER_EXPOSURE_AUTO_MAX_US="${BAUMER_EXPOSURE_AUTO_MAX_US:-12000}"
export BAUMER_GAIN_AUTO_MAX="${BAUMER_GAIN_AUTO_MAX:-32}"
...
Defaults:
  ...
  BAUMER_BRIGHTNESS_AUTO_NOMINAL=${BAUMER_BRIGHTNESS_AUTO_NOMINAL}
  BAUMER_EXPOSURE_AUTO_MAX_US=${BAUMER_EXPOSURE_AUTO_MAX_US}
  BAUMER_GAIN_AUTO_MAX=${BAUMER_GAIN_AUTO_MAX}
